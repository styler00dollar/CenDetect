...
# Running from source
There are 2 ways to install it, with and without anaconda. If you don't want to use anaconda, install python. Python is already preinstalled in Linux based distros. Anaconda is recommended. If you do not use Anaconda, then you maybe need to install cuda yourself.
